...
local energy = 99999999.99999999
local maxEnergy = 99999999.99999999
local move_anim_speed = 99.99999999
local last_p = Vector3.new()
local move_amm = 99999999
local walking = false
local running = false
...
game.Players.LocalPlayer.Backpack.ChildAdded:connect(function(c)
	...
	elseif c.Name == "Gun" and not Gun then
		spawn(function()
			Ability = ABIL
			Perk = PERKY
			if Ability == nil then
...
WC.ThrowKnife(Char, Char, Mouse.Hit.p, "Boom Blade")
end)
